...
class ToDosControllerTest < ActionController::TestCase
  ...
  test "should create to_do" do
    assert_difference('ToDo.count') do
      post :create, to_do: { due_date: @to_do.due_date, notes: @to_do.notes, title: @to_do.title, user_id: @to_do.user_id }
    end
  ...
  test "should update to_do" do
    patch :update, id: @to_do, to_do: { due_date: @to_do.due_date, notes: @to_do.notes, title: @to_do.title, user_id: @to_do.user_id }
    assert_redirected_to to_do_path(assigns(:to_do))
  end
